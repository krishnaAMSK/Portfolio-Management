          ...
          <div class="wrapper">
            <div class="cards-wrap">
              <div class="card_item">
                ...
                <div clas="card-inner" style={{ float: 'right' }}>
                  <img
                    src="/man.png"
                    alt="Profile picture"
          ...
          {projects[0]?.projects.map((project) => (
            <div class="skillColumn">
              <div class="skillCard">
                ...
                <div className="projectDiscription">{project.description}</div>
                <a href={project.source} className="projectLink">GitHub Link</a>
              </div>
            </div>
          ))}
        </div>
